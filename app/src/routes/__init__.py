...
from app.src.routes.api_routes.twilio_messages_routes import router as twilio_messages_router
...
api_router.include_router(twilio_messages_router, prefix="/api/v1")
